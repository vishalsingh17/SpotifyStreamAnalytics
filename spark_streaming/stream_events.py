...
# load env and set configurations
...
def create_write_stream(df: DataFrame, checkpoint_path: str, output_path: str, trigger: str = "2 minutes"):    
    '''
    _summary_
...
# Read stream events
stream_df = create_read_stream(stream_df, KAFKA_BOOTSTRAP_SERVER, KAFKA_TOPIC_NAME)
print("Stream is processed")

# Process stream events
stream_df = process_stream(stream_df, EVENTS_SCHEMA)

# Create an empty table at destination and enable CDC
